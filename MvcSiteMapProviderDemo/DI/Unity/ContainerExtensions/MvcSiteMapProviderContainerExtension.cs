...
using MvcSiteMapProviderDemo.Utils;

namespace MvcSiteMapProviderDemo.DI.Unity.ContainerExtensions
{
        ...
        : UnityContainerExtension
    {
        protected override void Initialize()
        {
            ...
            string[] includeAssembliesForScan = new string[] { "MvcSiteMapProviderDemo" };
